...
public class StudentCRUDTest extends TestBase {
    ...
    static String firstName = "Dhanno" + TestUtils.getRandomValue();
    static String lastName = "Runner" + TestUtils.getRandomValue();
    static String email = "dhannorunner" + TestUtils.getRandomValue() + "@gmail.com";
    static String programme = "Natsamrat";
